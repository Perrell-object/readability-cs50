...
Writing a program that takes a piece of text, and determines its reading level. 
if user types in a line of text from Dr. Seuss, the program should behave as follows:
...
C code that just gets some text input from the user, and prints it back out. Specifically, implement in readability.c 
...
![code snippet](resources/readability.png)
